                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative flex items-center">
                                <!-- Icon Notifications -->
                                                  <div @click="idMenu=5">
                                                    <svg @click="showNotifications()" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex  rounded-md">
                                            ...
                                            >
                                                ...
                                                <!-- Photo Profile User -->
                                                <img src="#" alt="profile-photo" class="bg-gray-800 w-[34px] h-[34px] rounded-[25px] flex  " >
