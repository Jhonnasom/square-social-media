...
<template>
    ...
    >
        ...
        <div class="max-w-7xl min-h-screen min-w-full mx-auto p-6 lg:p-8 bg-primary-color">
  ...
  <rect width="168" height="49" fill="white"/>
                            ...
                            <h2 class="mt-2 text-6xl font-semibold text-white dark:text-white">Welcome</h2>
