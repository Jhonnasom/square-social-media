    ...
    <AuthenticatedLayout>
      <!-- AsideBar -->
        <template #header>
          ...
          <div class="flex gap-[10px] ps-3 mb-5 pt-3 w-[230px] min-h-[64px] bg-[#fafafb] rounded-[15px] border border-secondary-gray" @click="idMenu = 4">
            <!-- Photo Profile User -->
          ...
          <div class="flex gap-4 flex-col  w-[250px] ">
            <!-- Feed -->
              <div class="h-[34.6px] w-[250px]">
                <a href="#" class="flex gap-5 items-center" @click="idMenu=1">
                  <!-- svg feed -->
              ...
              <!-- Friends -->
              <div class="h-[34.6px] w-[250px]">
                  <a href="#" class="flex gap-5 items-center" @click="idMenu = 2">
                    <!-- svg friends -->
              ...
              <!-- Photos -->
              <div class="h-[34.6px] w-[250px]">
                    <a href="#" class="flex gap-5 items-center" @click="idMenu = 3">
                      <!-- svg photos -->
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
