    ...
    <div class="min-w-[902px] min-h[40px] mt-[32px]">
        ...
        <div class="flex h-10 items-center justify-between mb-9">
            ...
            <div class="flex items-center w-[55%] rounded-[10px] pl-3 bg-white">
                <h2 class="text-sm font-normal font-[Roboto] text-[#696974]">
                    Sort by:
                </h2>
                <select
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="h-[200px] rounded-[15px] bg-violet-800 flex items-end">
                <!-- Comments and likes -->
                <div
                    class="flex items-end h-[86px] w-full rounded-b-[15px] p-5 gap-3"
                >
                    <!-- Likes -->
                    <div>
                        <span
                            class="text-sm text-white flex gap-1 items-center"
                        >
                            <svg
