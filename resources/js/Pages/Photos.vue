   ...
   <div class="min-w-[902px]  min-h[40px] mt-[32px]">
     ...
     <div class="grid md:grid-cols-3 gap-5">
      <!-- Container de una foto -->
        <div class="h-[200px] rounded-[15px] bg-violet-800 flex items-end">
          <!-- Comments and likes -->
             <div class="flex items-end h-[86px] w-full rounded-b-[15px] p-5 gap-3">
              <!-- Likes -->
                <div>
                  <span class="text-sm text-white flex gap-1 items-center">
                ...
                <div>
                    <span class="text-sm text-white flex gap-1 items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 25" fill="none">
        ...
        <!-- Container de una foto -->
        <div class="h-[200px] rounded-[15px] bg-pink-800 flex items-end">
            <!-- Comments and likes -->
               <div class="flex items-end h-[86px] w-full rounded-b-[15px] p-5 gap-3">
                <!-- Likes -->
                  <div>
        ...
        <!-- Container de una foto -->
        <div class="h-[200px] rounded-[15px] bg-gray-800 flex items-end">
            <!-- Comments and likes -->
               <div class="flex items-end h-[86px] w-full rounded-b-[15px] p-5 gap-3">
                <!-- Likes -->
                  <div>
